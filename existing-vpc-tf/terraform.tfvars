...
hyperpod_availability_zone_id = "use2-az2"  # Explicit AZ-ID

# EKS Subnets Configuration
eks_private_subnet_cidrs = ["10.192.7.0/24", "10.192.8.0/24"]
eks_private_availability_zone_ids = ["use2-az2", "use2-az3"]  # Explicit AZ-IDs for EKS private subnets
eks_private_node_subnet_cidr = "10.192.9.0/24"
eks_private_node_availability_zone_id = "use2-az2"  # Explicit AZ-ID for EKS private node subnet
